        ...
        <div className="space-y-6 order-2 lg:order-1 max-w-lg w-full">
          ...
          <div className="space-y-6">
            <div className="flex gap-3 items-start">
              <Image src="/home/skills/img.svg" alt="Report Icon" width={40} height={40} />
              <div>
                <h3 className="text-lg md:text-xl font-semibold">Comprehensive Performance Insights</h3>
                <p className="text-gray-700">
                  Get detailed analytics and performance metrics to make data-driven hiring decisions.
                </p>
              </div>
            </div>

            <div className="flex gap-3 items-start">
              <Image src="/home/skills/img2.svg" alt="Analytics Icon" width={40} height={40} />
              <div>
                <h3 className="text-lg md:text-xl font-semibold">Custom Report Generation</h3>
                <p className="text-gray-700">
                  Generate customized reports to analyze candidate performance across different parameters.
                </p>
              </div>
            </div>
          </div>
